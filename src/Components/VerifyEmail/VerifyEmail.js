    ...
    return (
        <FullHeight className="verifyEmail">
            <div className="verifyEmailDetails">
                ...
                <h4><FontAwesomeIcon className="checkFont" icon={faCheck} /> A verification link has been send to your email account <Button onClick={auth.sendEmailVerification}>Resend</Button></h4>
